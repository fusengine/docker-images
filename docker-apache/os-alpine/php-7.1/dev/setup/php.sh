...
PACK_DEFAULT="  apache-mod-fcgid php7.1-apache2 php7.1 php7.1-fpm php7.1-cgi php7.1-dev \
                ...
                php7.1-zlib php7.1-xmlreader php7.1-mongodb php7.1-xmlwriter php7.1-xml php7.1-simplexml php7.1-dom php7.1-fileinfo php7.1-intl \
...
# Xdebug config
rm -rf /etc/php/7.1/conf.d/xdebug.ini
