...
# add packages
PACK_DEFAULT="  php7.0 apache-mod-fcgid php7.0-apache2 php7.0-fpm php7.0-cgi php7.0-dev \
                ...
                php7.0-zlib php7.0-xmlreader php7.0-mongodb php7.0-xmlwriter php7.0-xml php7.0-simplexml php7.0-dom php7.0-fileinfo php7.0-intl \
...
# symbolik links
#ln -s /usr/bin/php7.0.1 /usr/bin/php
...
# Xdebug config
rm -rf /etc/php/7.0/conf.d/xdebug.ini
