...
PACK_DEFAULT="  apache-mod-fcgid php$PHP_VERSION-apache2 php$PHP_VERSION php$PHP_VERSION-fpm php$PHP_VERSION-cgi php$PHP_VERSION-dev \
                ...
                php$PHP_VERSION-imap php$PHP_VERSION-session php$PHP_VERSION-xdebug php$PHP_VERSION-mcrypt php$PHP_VERSION-pspell php$PHP_VERSION-phar php$PHP_VERSION-imagick php$PHP_VERSION-memcached php$PHP_VERSION-pdo \
